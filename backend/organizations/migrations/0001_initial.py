# Generated by Django 3.2.3 on 2023-11-03 08:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house', models.PositiveIntegerField(validators=[django.core.validators.MinLengthValidator(1, message='Минимум 1 символ'), django.core.validators.MaxLengthValidator(6, message='Максимум 65 символов')], verbose_name='Дом')),
            ],
            options={
                'verbose_name': 'Адрес',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.CharField(max_length=18, validators=[django.core.validators.MinLengthValidator(18, message='Минимум 18 символов'), django.core.validators.RegexValidator(message='Неправильный формат номера телефона.', regex='^\\+7\\(\\d{3}\\)\\d{7}$')], verbose_name='Номер телефона')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login', models.CharField(max_length=60, unique=True, validators=[django.core.validators.MinLengthValidator(5, message='Минимум 5 символов'), django.core.validators.RegexValidator(message='Логин может содержать только символы английского алфавита.', regex='^[a-z]+$')], verbose_name='Логин')),
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizations.address', verbose_name='Адрес спортивной школы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.PositiveIntegerField(validators=[django.core.validators.MinLengthValidator(1, message='Минимум 1 символ'), django.core.validators.MaxLengthValidator(1, message='Максимум 1 символ'), django.core.validators.MinValueValidator(1, message='Минимумальное значение 1'), django.core.validators.MaxValueValidator(5, message='Максимальное значение 5')], verbose_name='Рейтинг')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveIntegerField(validators=[django.core.validators.MinLengthValidator(1, message='Минимум 1 символ'), django.core.validators.MaxLengthValidator(6, message='Максимум 2 символа')], verbose_name='Возраст ребенка')),
                ('gender', models.CharField(max_length=7, verbose_name='Пол ребенка')),
                ('phone', models.CharField(max_length=18, validators=[django.core.validators.MinLengthValidator(18, message='Минимум 18 символов'), django.core.validators.RegexValidator(message='Неправильный формат номера телефона.', regex='^\\+7\\(\\d{3}\\)\\d{7}$')], verbose_name='Номер телефона для связи')),
